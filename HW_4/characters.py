...
# get frequency for word cloud 
with open('iliad_characters_frequency.txt', 'w') as fi:
    for frequency in characters_freq:
        fi.write(str(frequency))
        fi.write('\n')
